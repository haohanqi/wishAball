...
import { EntrySectionWrapper, EntryTitle, EntryDes, TopNewsWrapper, TopNewsItemWrapper, TopNewsTitle} from './style'

const TopNewsItem = ()=>{
	return (
		<TopNewsItemWrapper className="top-news-item">
			<TopNewsTitle>Winter Kids Basketball Train startAt Feb 4th 2021</TopNewsTitle>
