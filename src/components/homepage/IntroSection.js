...
import { IntroSectionWrapper, BasicTitleStyle, IntroDes, IntroPanelWrapper, IntroPanel} from './style'
		...
		<IntroSectionWrapper>
			<Row style={{height:"100%"}} justify="space-between" align="middle">
				<Col xxl={12} xl={10} lg={18} sm={20} xs={20} align="left">
					...
					<IntroDes>Contrary to popular belief, Lorem Ipsum is not simply random 
					has roots in a piece of classical Latin literature from 45 BC, 
					making it over 2000 years old. Richard McClintock, 
					a Latin professor at Hampden-Sydney College in Virginia, 
					looked up one of the more obscure Latin words</IntroDes>
				</Col>
				...
				<Col xxl={12} xl={12} lg={24} sm={24} xs={24} align="center">
					<IntroPanelWrapper>
						<IntroPanel src="https://images.unsplash.com/photo-1570878786170-0723365bdf35?ixlib=rb-1.2.1&ixid=eyJhcHBfaWQiOjEyMDd9&w=1000&q=80">
							...
							<div className="panelDes">Sed ut perspiciatis unde omnis iste natus error sit voluptatem</div>
						</IntroPanel>
