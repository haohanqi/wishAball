				...
				<Col xxl={12} xl={12} md={12} sm={24} xs={24} align="center">
					<div className="details-info-part">
						<div className="details-info">
							<BasicTitleStyle width="100px" style={{marginBottom:"0px",fontSize:"1rem"}}>Sport</BasicTitleStyle>
							<div className="details-info-des">{pageContext.sport}</div>
						</div>
						<div className="details-info">
							<BasicTitleStyle width="100px" style={{ marginBottom: "0px", fontSize: "1rem" }}>Address</BasicTitleStyle>
							<div className="details-info-des">{pageContext.address}</div>
						</div>
						<div className="details-info">
							<BasicTitleStyle width="100px" style={{ marginBottom: "0px", fontSize: "1rem" }}>phone</BasicTitleStyle>
							<div className="details-info-des">{pageContext.phone}</div>
						</div>
						<div className="details-info">
							<BasicTitleStyle width="100px" style={{ marginBottom: "0px", fontSize: "1rem" }}>Website</BasicTitleStyle>
